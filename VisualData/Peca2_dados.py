...
def peca2():
    ...
    for i in range(np.size(peca2_lineloop)): #percorro todo o vetor de sequencia de linhas
        
    
        for j in range(np.size(peca2_lineloop[i])): #percorre a linha do lineloop
